export const mockFrameworkData = {
  ...
  success: {
      ...
      'frameworkdata': [{
          ...
          'terms': [{
              ...
              },
              {
                  ...
                  'code': 'grade4', 'name': 'Grade 4', 'description': '',
                  'category': 'gradeLevel', 'status': 'Live'
              },
              {
                  'identifier': 'ncf_gradelevel_grade3', 'code': 'grade3',
                  'name': 'Grade 3', 'description': '',
                  'category': 'gradeLevel', 'status': 'Live'
              },
              {
          ...
          },
          {
              ...
              'name': 'BSER', 'description': '', 'index': 9,
              'category': 'board', 'status': 'Live'
          },
          {
              'identifier': 'ncf_board_others', 'code': 'others',
              'name': 'Others', 'description': 'others', 'index': 10,
              'category': 'board', 'status': 'Live'
          }],
      ...
      },
      {
          ...
          'terms': [{
              ...
              'name': 'Kindergarten', 'description': '', 'index': 1,
              'category': 'gradeLevel', 'status': 'Live'
          },
          {
          ...
          },
          {
              ...
              'description': '', 'index': 4, 'category': 'gradeLevel', 'status': 'Live'
          },
          {
              'identifier': 'ncf_gradelevel_grade4', 'code': 'grade4', 'name': 'Grade 4',
              'description': '', 'index': 5, 'category': 'gradeLevel', 'status': 'Live'
          },
          {
              'identifier': 'ncf_gradelevel_grade5', 'code': 'grade5', 'name': 'Grade 5',
              'description': '', 'index': 6, 'category': 'gradeLevel', 'status': 'Live'
          },
          {
              'identifier': 'ncf_gradelevel_grade6', 'code': 'grade6', 'name': 'Grade 6',
              'description': '', 'index': 7, 'category': 'gradeLevel', 'status': 'Live'
          },
          {
              'identifier': 'ncf_gradelevel_grade7', 'code': 'grade7', 'name': 'Grade 7',
              'description': '', 'index': 8, 'category': 'gradeLevel', 'status': 'Live'
          },
          {
          ...
          {
              'identifier': 'ncf_gradelevel_grade10', 'code': 'grade10', 'name': 'Grade 10',
              'description': '', 'index': 11, 'category': 'gradeLevel', 'status': 'Live'
          },
          {
              'identifier': 'ncf_gradelevel_grade11', 'code': 'grade11', 'name': 'Grade 11',
              'description': '', 'index': 12, 'category': 'gradeLevel', 'status': 'Live'
          },
          {
      ...
      },
      {
          ...
          'terms': [{
              ...
              'code': 'environmentalstudies', 'name': 'Environmental Studies',
              'description': '', 'index': 13, 'category': 'subject', 'status': 'Live'
          },
          {
          ...
          'terms': [{
              ...
              'description': '', 'index': 1, 'category': 'medium',
              'status': 'Live'
          },
          {
  ...
  frameworkError: {
      ...
      'frameworkdata': [{
          ...
          {
              'identifier': 'ncf_board_icse', 'code': 'icse', 'name': 'ICSE', 'description': '',
              'index': 3, 'category': 'board', 'status': 'Live'
          },
          {
              'identifier': 'ncf_board_upboard', 'code': 'upboard', 'name': 'UP Board',
              'description': '', 'index': 4, 'category': 'board', 'status': 'Live'
          ...
          {
              'identifier': 'ncf_board_bser', 'code': 'bser', 'name': 'BSER', 'description': '',
              'index': 9, 'category': 'board', 'status': 'Live'
          },
          {
              'identifier': 'ncf_board_others', 'code': 'others', 'name': 'Others', 'description': 'others',
              'index': 10, 'category': 'board', 'status': 'Live'
          }],
          'name': 'Curriculum', 'description': '', 'index': 1, 'status': 'Live'
      }, {
          ...
          'identifier': 'ncf_subject', 'code': 'subject', 'terms': [{
              'identifier': 'ncf_subject_mathematics',
              'code': 'mathematics', 'name': 'Mathematics', 'description': '', 'index': 1, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_english', 'code': 'english', 'name': 'English',
              'description': '', 'index': 2, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_tamil', 'code': 'tamil', 'name': 'Tamil',
              'description': '', 'index': 3, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_telugu', 'code': 'telugu', 'name': 'Telugu',
              'description': '', 'index': 4, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_geography', 'code': 'geography', 'name': 'Geography',
              'description': '', 'index': 5, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_urdu', 'code': 'urdu', 'name': 'Urdu', 'description': '',
              'index': 6, 'category': 'subject', 'status': 'Live'
          }, {
              'identifier': 'ncf_subject_kannada',
              'code': 'kannada', 'name': 'Kannada', 'description': '', 'index': 7, 'category': 'subject',
              'status': 'Live'
          }, {
              'identifier': 'ncf_subject_assamese', 'code': 'assamese', 'name': 'Assamese',
              'description': '', 'index': 8, 'category': 'subject', 'status': 'Live'
          }, {
              'identifier': 'ncf_subject_physics',
              'code': 'physics', 'name': 'Physics', 'description': '', 'index': 9, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_chemistry', 'code': 'chemistry', 'name': 'Chemistry', 'description': '', 'index': 10,
              'category': 'subject', 'status': 'Live'
          }, {
              'identifier': 'ncf_subject_hindi', 'code': 'hindi', 'name': 'Hindi', 'description': '',
              'index': 11, 'category': 'subject', 'status': 'Live'
          }, {
              ...
              'identifier': 'ncf_subject_politicalscience', 'code': 'politicalscience',
              'name': 'Political Science', 'description': '', 'index': 14, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_bengali', 'code': 'bengali', 'name': 'Bengali', 'description': '', 'index': 15,
              'category': 'subject', 'status': 'Live'
          }, {
              'identifier': 'ncf_subject_history', 'code': 'history', 'name': 'History',
              'description': '', 'index': 16, 'category': 'subject', 'status': 'Live'
          }, {
              'identifier': 'ncf_subject_gujarati', 'code': 'gujarati',
              'name': 'Gujarati', 'description': '', 'index': 17, 'category': 'subject', 'status': 'Live'
          }, {
              'identifier': 'ncf_subject_biology', 'code': 'biology', 'name': 'Biology', 'description': '',
              'index': 18, 'category': 'subject', 'status': 'Live'
          }, {
              'identifier': 'ncf_subject_oriya',
              'code': 'oriya', 'name': 'Oriya', 'description': '', 'index': 19, 'category': 'subject',
              'status': 'Live'
          }, {
              'identifier': 'ncf_subject_punjabi', 'code': 'punjabi', 'name': 'Punjabi',
              'description': '', 'index': 20, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_nepali', 'code': 'nepali',
              'name': 'Nepali', 'description': '', 'index': 21, 'category': 'subject', 'status': 'Live'
          },
          {
              'identifier': 'ncf_subject_malayalam', 'code': 'malayalam', 'name': 'Malayalam',
              'description': '', 'index': 22, 'category': 'subject', 'status': 'Live'
          }],
  ...
  frameworkSuccess: {
      ...
      'params': {
          ...
          'msgid': '1ab024d0-3e4f-11e8-ba4c-69964c53fa34',
      ...
      'result': {
          'framework':
              {
                  'owner': 'in.ekstep', 'identifier': 'NCF',
                  'code': 'NCF', 'consumerId': 'a6654129-b58d-4dd8-9cf2-f8f3c2f458bc',
                  ...
                  'name': 'NCF framework', 'lastUpdatedOn': '2018-04-11T06:11:01.978+0000',
                  'categories': [{
                      'identifier': 'ncf_board', 'code': 'board',
                      'terms': [{
                          'associations': [{
                      ...
                      {
                          'identifier': 'ncf_board_upboard', 'code': 'upboard', 'name': 'UP Board', 'description': '',
                          'index': 4, 'category': 'board', 'status': 'Live'
                      },
                      {
                      ...
                      {
                          'identifier': 'ncf_board_tnboard', 'code': 'tnboard', 'name': 'TN Board', 'description': '',
                          'index': 6, 'category': 'board', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_board_ncte', 'code': 'ncte', 'name': 'NCTE', 'description': '',
                          'index': 7, 'category': 'board', 'status': 'Live'
                      ...
                      {
                          'identifier': 'ncf_board_mscert', 'code': 'mscert', 'name': 'MSCERT', 'description': '',
                          'index': 8, 'category': 'board', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_board_bser', 'code': 'bser', 'name': 'BSER', 'description': '',
                          'index': 9, 'category': 'board', 'status': 'Live'
                      ...
                      'identifier': 'ncf_gradelevel', 'code': 'gradeLevel', 'terms': [{
                          'identifier': 'ncf_gradelevel_kindergarten', 'code': 'kindergarten', 'name': 'Kindergarten',
                          'description': '', 'index': 1, 'category': 'gradeLevel', 'status': 'Live'
                      }, {
                          'identifier': 'ncf_gradelevel_grade1', 'code': 'grade1', 'name': 'Grade 1', 'description': '',
                          'index': 2, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade2', 'code': 'grade2', 'name': 'Grade 2', 'description': '',
                          'index': 3, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade3', 'code': 'grade3', 'name': 'Grade 3', 'description': '',
                          'index': 4, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade4', 'code': 'grade4', 'name': 'Grade 4', 'description': '',
                          'index': 5, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade5', 'code': 'grade5', 'name': 'Grade 5', 'description': '',
                          'index': 6, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade6', 'code': 'grade6', 'name': 'Grade 6', 'description': '',
                          'index': 7, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade7', 'code': 'grade7', 'name': 'Grade 7', 'description': '',
                          'index': 8, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade8', 'code': 'grade8', 'name': 'Grade 8', 'description': '',
                          'index': 9, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade9', 'code': 'grade9', 'name': 'Grade 9', 'description': '',
                          'index': 10, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade10', 'code': 'grade10', 'name': 'Grade 10', 'description': '',
                          'index': 11, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade11', 'code': 'grade11', 'name': 'Grade 11', 'description': '',
                          'index': 12, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_grade12', 'code': 'grade12', 'name': 'Grade 12', 'description': '',
                          'index': 13, 'category': 'gradeLevel', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_gradelevel_others', 'code': 'others', 'name': 'Other', 'description': '',
                          'index': 14, 'category': 'gradeLevel', 'status': 'Live'
                      }], 'name': 'Class', 'description': '', 'index': 2, 'status': 'Live'
                  }, {
                      'identifier': 'ncf_subject', 'code': 'subject',
                      'terms': [{
                          'identifier': 'ncf_subject_mathematics', 'code': 'mathematics', 'name': 'Mathematics', 'description': '',
                          'index': 1, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_english', 'code': 'english', 'name': 'English', 'description': '',
                          'index': 2, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_tamil', 'code': 'tamil', 'name': 'Tamil', 'description': '',
                          'index': 3, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_telugu', 'code': 'telugu', 'name': 'Telugu', 'description': '',
                          'index': 4, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_geography', 'code': 'geography', 'name': 'Geography', 'description': '',
                          'index': 5, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_urdu', 'code': 'urdu', 'name': 'Urdu', 'description': '',
                          'index': 6, 'category': 'subject', 'status': 'Live'
                      ...
                      {
                          'identifier': 'ncf_subject_kannada', 'code': 'kannada', 'name': 'Kannada', 'description': '',
                          'index': 7, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_assamese', 'code': 'assamese', 'name': 'Assamese', 'description': '',
                          'index': 8, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_physics', 'code': 'physics', 'name': 'Physics', 'description': '',
                          'index': 9, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_chemistry', 'code': 'chemistry', 'name': 'Chemistry', 'description': '',
                          'index': 10, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_hindi', 'code': 'hindi', 'name': 'Hindi', 'description': '',
                          'index': 11, 'category': 'subject', 'status': 'Live'
                      ...
                      {
                          'identifier': 'ncf_subject_marathi', 'code': 'marathi', 'name': 'Marathi', 'description': '',
                          'index': 12, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_environmentalstudies', 'code': 'environmentalstudies',
                      ...
                      {
                          'identifier': 'ncf_subject_politicalscience', 'code': 'politicalscience', 'name': 'Political Science',
                          'description': '', 'index': 14, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_bengali', 'code': 'bengali', 'name': 'Bengali',
                          'description': '', 'index': 15, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_history', 'code': 'history', 'name': 'History',
                          'description': '', 'index': 16, 'category': 'subject', 'status': 'Live'
                      ...
                      {
                          'identifier': 'ncf_subject_gujarati', 'code': 'gujarati', 'name': 'Gujarati',
                          'description': '', 'index': 17, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_biology', 'code': 'biology', 'name': 'Biology',
                          'description': '', 'index': 18, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_oriya', 'code': 'oriya', 'name': 'Oriya',
                          'description': '', 'index': 19, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_punjabi', 'code': 'punjabi', 'name': 'Punjabi',
                          'description': '', 'index': 20, 'category': 'subject', 'status': 'Live'
                      ...
                      {
                          'identifier': 'ncf_subject_nepali', 'code': 'nepali', 'name': 'Nepali',
                          'description': '', 'index': 21, 'category': 'subject', 'status': 'Live'
                      },
                      {
                          'identifier': 'ncf_subject_malayalam', 'code': 'malayalam', 'name': 'Malayalam',
                          'description': '', 'index': 22, 'category': 'subject', 'status': 'Live'
