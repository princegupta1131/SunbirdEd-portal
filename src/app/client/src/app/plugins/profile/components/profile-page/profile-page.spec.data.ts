export const Response = {
    userData: {
        ...
        'identifier': '95e4942d-cbe8-477d-aebd-ad8e6de4bfc8',
        'profileVisibility': {
            'lastName': 'public',
            'webPages': 'private',
            'jobProfile': 'private',
        ...
        'thumbnail': null,
        'updatedBy': '95e4942d-cbe8-477d-aebd-ad8e6de4bfc8',
        'externalIds': [],
        'registryId': null,
        'roleList': [
            {
    ...
    event: {
        ...
        'data': {
            'name': 'H5PContent',
            'image': 'https://sunbirddev.blob.cot/do_11262255104183500812/artifact/cloud-upload-1_1540304210166.thumb.png',
            'description': 'H5PContent',
            'rating': '0',
            'action': {
                'onImage': {
                    'eventName': 'onImage'
            ...
            'metaData': {
                'identifier': 'do_11262255104183500812',
    ...
    svgCertificates: [
        {
            'identifier': '0fd2008f-b2a1-479f-ac98-0b5dfa9707e9',
            'lastIssuedOn': '2020-08-20T06:26:01.423+0000',
    ...
    pdfCertificate: [
        {
            'id': '1d716558-b278-45e1-9c61-cf68b9f4a7ef',
            'lastIssuedOn': '2020-07-15T05:37:21.874+0000',
            'name': 'Course merit certificate',
            'token': 'H3R7P4',
            'url': 'https://staging.ntp.net.in/certs/0124784842112040965_0130645322226647040/3feb12d0-c65d-11ea-a42f-51f91f72670a.pdf'
        }
    ],
    v1DownloadCertResponse: {
...
export const personaFormConfig = [
    {
      'code': 'teacher',
      'name': 'Teacher',
